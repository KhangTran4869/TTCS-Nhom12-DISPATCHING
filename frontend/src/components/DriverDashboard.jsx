  ...
  const updateAssignmentStatus = async (status) => {
    ...
    try {
      ...
      if (status === "rejected") {
        ...
        showToast(
          "Bạn đã từ chối chuyến đi. Driver, xe và đơn hàng đã được đưa về trạng thái ban đầu.",
          "success",
        );
        ...
        // Cập nhật lại hồ sơ tài xế trên giao diện
        await fetchData();
